...
class DataPlotting:
    ...
    @staticmethod
    def plot_result_cae(result_plot, x_label, y_label, font_size, parent_dir, directory, file_name, mse):
        original_data = result_plot[0].reshape((32, 32))
        reconstructed_data = result_plot[1].reshape((32, 32))
        ...
        fig.suptitle('MSE = ' + str(mse), fontsize=20)
        ...
        ax[1].imshow(reconstructed_data)
