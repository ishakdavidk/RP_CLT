...
class DataPlotting:
    ...
    def plot_data_comp(self, data_1, data_2, x_label, y_label, font_size, dir_name, file_name, label):
        font = {'family': 'DejaVu Sans',
                'weight': 'bold',
                'size': font_size}
        ...
        min_time, max_time, delta, shape = self.information(data_1, "Data 1 : ")
        min_time_2, max_time_2, delta_2, shape_2 = self.information(data_2, "Data 2 : ")
        ...
        if min_time == min_time_2 and max_time == max_time_2 and shape == shape_2:
            plt.suptitle(str(min_time) + ' to ' + str(max_time)
                         + '\nTime delta : ' + str(delta) + '\nShape : ' + str(shape),
                         fontsize=20, y=0.95)
