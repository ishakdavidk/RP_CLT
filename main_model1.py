...
data_train = data_prep.training_matrix_GPU(data_train_raw, window, 10) # GPU
# data_train = data_prep.training_matrix_CPU(data_train_raw, window, 10) # CPU
...
print('\nTest false data shape : ', data_test_false.shape)
...
print('MSE test data (s2_false) : ', mse_false)
